...
export const About = () => {
  return (
    <>
      <h2>About</h2>
      <p>
        This project includes and demonstrates usage of recommended packages and
        tools:
      </p>
      <ul>
        <li>
        ...
        <li>
          <a href='https://vitest.dev/'>Vitest</a> - Next generation testing
        ...
        <li>
          <a href='https://tanstack.com/router/latest'>TanStack Router</a> - A
          fully type-safe React router with built-in data fetching, stale-while
          revalidate caching and first-class search-param APIs.
        </li>
        <li>
          <a href='https://github.com/formatjs/react-intl'>React Intl</a> -
          React components and an API to format dates, numbers, and strings,
