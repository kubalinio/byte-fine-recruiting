...
const buttonVariants = tv({
  slots: {
    button:
      "inline-flex items-center justify-center rounded-md font-bold ring-offset-background whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
    loading:
