...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "shadow-z1 data-[state=checked]:bg-primary pointer-events-none block size-5 rounded-full bg-gray-100 ring-0 transition-all data-[state=checked]:translate-x-5 data-[state=unchecked]:-translate-x-1.5"
      )}
    />
  </SwitchPrimitives.Root>
));
